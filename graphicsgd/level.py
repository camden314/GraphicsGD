...
class Level:
	...
	def uploadLevel(self,username,password,description="",stars=0,unlisted=0,lpassword=0,songid=0,audiotrack=1,twoPlayer=0,fromString=False):
		if not fromString:
			self.encodee()
		else:
			self.encoded = self.str
		seed2 = makeSeed(self.encoded)
		dictionary = {"accountID":getAccountID(username),"gjp":xor(password,"37526"),"userName":username,"levelID":0,"levelName":self.name,"levelDesc":base64.b64encode(description.encode()),"levelVersion":"1","levelLength":"0","audioTrack":str(audiotrack),"auto":"0","password":str(lpassword),"original":"0","twoPlayer":str(twoPlayer),"songID":str(songid),"objects":str(len(self.blocks)),"coins":"0","requestedStars":str(stars),"unlisted":str(unlisted),"wt":"13","wt2":"0","ldm":"0","seed":"BBUEIHF1rd","extraString":"0_0_0_0_0_0_0_0_0_0_0_0_0_0_0_0_0_0_0_0_0_0_0_0_0_0_0_0_0_0_0_0_0_0_0_0_0_0_0_0_0_0_0_0_0_0_0_0_0_0_0_0_0_0_0","seed2":seed2,"levelString":self.encoded,"secret":"Wmfd2893gb7","levelInfo":"H4sIAAAAAAAAEzOwNrQ20DMwsrY21DMztbYGAJp7I8gQAAAA"}
		dictionary.update(starting)
		return urlopen("http://boomlings.com/database/uploadGJLevel21.php",urlencode(dictionary)).read().decode()
	def __str__(self):
